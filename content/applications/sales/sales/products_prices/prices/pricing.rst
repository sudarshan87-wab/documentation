...
accounts for the unique discount being applied. However, if :guilabel:`Show public price & discount
to the customer` is selected, the customer sees the actual public price *and* how much they are
saving with this pricelist discount.
