...
.. note::
  In Odoo 17 (and later), if a loyalty/coupon card is related to a contact in the database, a
  :guilabel:`Loyalty Cards` smart button appears on the contact form (usually under the
  :guilabel:`More` drop-down menu at the top of the contact form).
